...
let pedro1 = [ "img/pedro-1.jpg", [1, 0.8, 0.47 ] ];
let manuel1 = [ "img/manuel-1.jpg", [1, 0.74, 0.49, 0.27] ];
let terhi1 = [ "img/terhi-1.jpg", [1, 0.74, 0.49, 0.241] ];
let sofia1 = [ "img/sofia-1.jpg", [1, 0.74, 0.49, 0.241] ];
let sofia2 = [ "img/sofia-2.jpg", [1, 0.74, 0.49, 0.241] ];
let x1 = [ "img/x-1.jpg", [1, 0.71, 0.475, 0.241] ];

let blank1 = [ 'img/blank-1.jpg', [1, 0.83, 0.535 ] ];
let michel2 = [ 'img/michel-2.jpg', [1, 0.73, 0.5] ];
let celeste1 = [ 'img/celeste-1.jpg', [1, 0.75, 0.5, 0.23] ];
let canvas;
...
function setup(){
	...
	//
	//
	window.addEventListener('load', createRotatingVolvelle (celeste1), false);
