...
let img1 = [ "img/img-1.png", [1, 0.9, 0.6, 0.36, 0.3, 0.25, 0.19 ] ];
let img2 = [ "img/img-2.png", [1, 0.835, 0.7, 0.55 ] ];
let img3 = [ "img/img-3.png", [1, 0.87, 0.42, 0.34] ];
let img4 = [ "img/img-4.png", [1, 0.82, 0.64 ] ];
let img5 = [ "img/img-5.png", [1, 0.74, 0.49] ];
let img6 = [ "img/img-6.png", [1, 0.95, 0.57, 0.2] ];
let img7 = [ 'img/img-7.png', [1, 0.87, 0.79, 0.7, 0.6, 0.51, 0.41, 0.3 ] ];
let img8 = [ 'img/img-8.png', [1, 0.78, 0.66, 0.56, 0.48] ];
...
function setup(){
	...
	//
	//
	window.addEventListener('load', createRotatingVolvelle (img1), false);
